                            ...
                            <div className="col-md-6">
                                <div className="banner-content">
                                  {/*   <h6 data-wow-duration="1s" data-wow-delay="0.5s" className="wow fadeInUp sub-title text-primary">We Create Ideas</h6> */}
                                    <h1 data-wow-duration="1.2s" data-wow-delay="1s" className="wow fadeInUp ">  <span className="text-primary">Give a helping </span> hand to those who need it!</h1>
                                    <p data-wow-duration="1.4s" data-wow-delay="1.5s" className="wow fadeInUp m-b30">When a child gets access to good food, it can change just about everything.</p>
