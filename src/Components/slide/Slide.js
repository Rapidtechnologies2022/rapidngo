...
function Slide() {
    return (
        <>
            <div className="banner-one" style={{ backgroundColor: "rgb(248, 250, 252)" }}>
                        ...
                        */} <div className="row align-items-center">
                            <div className="col-md-6">
                                <div className="banner-content">
                                    ...
                                    <p data-wow-duration="1.4s" data-wow-delay="1.5s" className="wow fadeInUp m-b30 text-black">When a child gets access to good food, it can change just about everything.</p>
                                    <a href="/services" ><a data-wow-duration="1.6s" data-wow-delay="2s" className="wow fadeInUp btn btn-link d-inline-flex align-items-center" style={{ color: "#1f2471" }} ><i className="fa fa-angle-right m-r10"></i>Ongoing programs</a></a>
                                </div>
                            </div>
                            <div className="col-md-6">
