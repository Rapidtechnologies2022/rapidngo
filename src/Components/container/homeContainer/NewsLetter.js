        ...
        <div className="row">
          ...
          <div className="col-md-3 pt-3 wow fadeInUp" data-wow-delay=".4s">
            ...
            <p className="mt-3 custom-heading">
              It is essential for the survival and well-being of all individuals. Consuming nutritious food and clean water can prevent various health issues. At Veni Foundation, we strive to provide access to clean and safe food and water for that in need.
            </p>
          </div>
          <div className="col-md-3 pt-3 wow fadeInUp" data-wow-delay=".5s">
            ...
            <p className="mt-3 custom-heading">
              Access to quality healthcare is vital for maintaining good health and well-being. Preventative care and education can help reduce the burden of illness and disease. Veni Foundation is committed to providing these resources to improve their health and quality of life.
            </p>
          </div>
          <div className="col-md-3 pt-3 wow fadeInUp" data-wow-delay=".5s">
